...
<body>
    ...
    <div class="orta_div" id="randevu_div">
      <form action="islem.php" method="post">
        ...
        <select name="hastane" class="hastane">
            ...
            <option value="Bölge eğitim araştırma hastanesi">Bölge eğitim araştırma hastanesi</option>
        ...
        <select name="klinik" class="klinik">
            ...
            <option value="Kulak hastalıkları">Kulak hastalıkları</option>
    ...
    <h3>Aile hekimi</h3>
        <p>Aile Hekiminize ait bir bilgi bulunamamıştır.</p>
    </div>
